...
<html>
  <head>
    ...
    <title><?= $apps;?></title>
    <meta name="author" content="Survei@gmail.com">
	...
	<body class="fixed-navbar fixed-layout">
        ...
        <header class="header">
		    <div class="page-brand">
		        <a class="link" href="#">
                    <img src="<?= base_url('template/logo.png'); ?>" width="30" style="vertical-align: sub;" title="">
		            <span class="brand">
                        <p>DISKOMSANTIK</p>
		            </span>
		      ...
		      <ul class="nav navbar-toolbar">
		        <li class="dropdown dropdown-user">
		            <a class="nav-link dropdown-toggle link" data-toggle="dropdown">
		            	<img src="<?= base_url('uploads/profil.png');?>">
        ...
        <nav class="page-sidebar" id="sidebar">
		  <div id="sidebar-collapse">
		    <div class="admin-block d-flex">
		        <div>
		        	<img src="<?= base_url('uploads/profil.png');?>" width="45px">
		        </div>
        ...
        <div class="content-wrapper">
            ...
            <footer class="page-footer">
                <div class="font-13"><?= date('Y');?> © <b>DISKOMSANTIK KABUPATEN PANDEGLANG </b>.</div>
