    ...
    <div class="ibox-body">
		<form method="post" id="form-validation" action="javascript:;" novalidate="novalidate">
			<div class="form-group row">
                <label class="col-sm-2 col-form-label">Nama Nama Survei</label>
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="nm_survei" placeholder="Nama Survei" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
    ...
    $(document).ready(function (){
        $("#form-validation").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type: "POST",
                    url : "<?= base_url('admin/savenamasurvei')?>",
                    data: {<?= csrf_token() ?>:'<?= csrf_hash() ?>',nm_survei:nm_survei},
