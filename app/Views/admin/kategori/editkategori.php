    ...
    <div class="ibox-body">
		<form method="post" id="form-validation" action="javascript:;" novalidate="novalidate">
			...
			<div class="form-group row">
                ...
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="title" value="<?= $kategori['title']; ?>" placeholder="Nama Kategori Berita" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
    ...
    $(document).ready(function (){
        $("#form-validation").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type: "POST",
                    url : "<?= base_url('admin/updatekategori')?>",
                    data: {<?= csrf_token() ?>:'<?= csrf_hash() ?>',title:title, id:id},
