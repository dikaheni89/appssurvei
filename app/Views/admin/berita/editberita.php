...
<div class="ibox">
    ...
    <div class="ibox-body">
		<form method="post" id="form-validation" action="javascript:;" enctype="multipart/form-data" novalidate="novalidate">
            <input type="hidden" name="id" value="<?= $berita['_id']; ?>">
			<div class="form-group row">
                <label class="col-sm-2 col-form-label">Title</label>
                <div class="col-sm-6">
                    <input class="form-control" type="text" name="title" value="<?= $berita['title']; ?>" placeholder="Title" autocomplete="off">
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    ...
                    <?php foreach ($kategori as $row) : ?>
                        <?php if ($berita['kategorimenu_id'] == $row['_id']) : ?>
                            <option value="<?= $row['_id'];?>" selected="selected"><?= $row['title'];?></option>
                        <?php else : ?>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-6">
                    <textarea id="summernote" data-plugin="summernote" class="form-control" name="deskripsi" value="<?= $berita['deskripsi']; ?>"><?= $berita['deskripsi']; ?></textarea>
                </div>
            </div>
    ...
    $(document).ready(function (){
        ...
        $("#form-validation").validate({
            ...
            submitHandler:function(form){
                ...
                $.ajax({
                    type: "POST",
                    url : "<?= base_url('admin/updateberita')?>",
                    async:false,
